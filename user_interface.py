...
def putwindow():
    ...
    tkinter.Label(window, text = " WELCOME TO FACE DETECTION AND RECOGNITION SOFTWARE ",font=("helvetica",15 , "bold") ,fg = "white", bg = "purple").pack(fill = "x")

    tkinter.Label(window, text = "GUIDELINES TO USE THIS SOFTWARE :",font=("helvetica",15 , "bold") ,fg = "purple").pack(fill = "x")

    tkinter.Label(window, text = " ").pack(fill = 'y')

    tkinter.Label(window, text = "This software allows user to:\n\n" , font=("helvetica", 15, "bold"), fg="purple").place(
        x=20,y=100)


    tkinter.Label(window, text="1) CREATE DATASET using MTCNN face detection and alignment\n", font=("helvetica", 15, "bold"), fg="purple").place(
        x=10, y=155)
    tkinter.Label(window, text="2) TRAIN FaceNet for face recognition                     \n", font=("helvetica", 15, "bold"), fg="purple").place(
        x=10, y=185)
    tkinter.Label(window, text="3) Do both                                                \n\n\n ", font=("helvetica", 15, "bold"), fg="purple").place(
        x=10, y=215)
    ...
    btn1 = tkinter.Button(window, text = "CONTINUE", fg = "white", bg = 'purple', command = cont_inue)
...
def show():
    ...
    tkinter.Label(window2, text = "^^ WELCOME TO FACE DETECTION AND RECOGNITION SOFTWARE ^^", fg="white", bg="purple").pack(fill="x")
    tkinter.Label(window2, text = '- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -', bg='purple').pack(fill='x')
    tkinter.Label(window2, text = '- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -', bg='purple').pack(fill='x')
    ...
    tkinter.Label(window2, text = "Click 'TRAIN' to TRAIN and maybe 'TEST later' by making a classifer on the facenet model.\n\n"
                  ...
                  fg = 'white', bg = 'purple').pack(fill = 'y')
    ...
    btn1 = tkinter.Button(bottom_frame, text = "TRAIN", fg = "white", bg = 'purple', command = train)
    btn1.place(x=230, y=350, width=50)

    btn2 = tkinter.Button(bottom_frame, text = "TEST", fg = "white", bg = 'purple', command = test)
    btn2.place(x=330, y=350, width=50)

    btn3 = tkinter.Button(bottom_frame, text = "CREATE", fg = "white", bg = 'purple', command = create)
    btn3.place(x=430, y=350, width=50)

    btn3 = tkinter.Button(bottom_frame, text = "RUN", fg = "white", bg = 'purple', command = run)
    btn3.place(x=530, y=350, width=50)

    btn4 = tkinter.Button(bottom_frame, text = "EXIT", fg = "white", bg = 'purple', command = s_exit)
...
def show_run():
    ...
    tkinter.Label(window3, text = "^^ WELCOME TO FACE DETECTION AND RECOGNITION SOFTWARE ^^", fg="white", bg="purple").pack(fill="x")
    tkinter.Label(window3, text = '', bg='purple').pack(fill='x')
    ...
    tkinter.Label(window3, text="Default values would be assigned to empyt fields", fg="white", bg="purple").place(x=700, y=200, width=380)
    tkinter.Label(window3, bg = 'purple')
    ...
    rdbi = tkinter.Checkbutton(window3, text="Input: Image", variable = rdbtn3, fg="black", bg="purple")
    ...
    rdbv = tkinter.Checkbutton(window3, text="Input: Video", variable = rdbtn2, fg="black", bg="purple")
    ...
    rdbw = tkinter.Checkbutton(window3, text="Input: Webcam", variable = rdbtn1, fg="black", bg="purple")
    ...
    btn9 = tkinter.Button(window3, text = "CONTINUE", fg = "white", bg = 'purple', command = submit)
    btn9.place(x=550, y=600, width=90)

    btn11 = tkinter.Button(window3, text = "Mark Attendance",fg = "white", bg = 'purple', command = mark_attend)
    btn11.place(x=635, y=630, width=120)

    btn10 = tkinter.Button(window3, text = "EXIT", fg = "white", bg = 'purple', command = s_exit)
    ...
    btn12 = tkinter.Button(window3, text = "HOME", fg = "white", bg = 'purple', command = home)
...
def show_create():
    ...
    tkinter.Label(window4, text = "^^ WELCOME TO FACE DETECTION AND RECOGNITION SOFTWARE ^^", fg = "white", bg = 'purple').pack(fill="x")
    tkinter.Label(window4, text = '- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -', bg='purple').pack(fill='x')
    ...
    rdbv = tkinter.Checkbutton(window4, text="Video", variable = rdbtn1, fg = "black", bg = 'purple')
    rdbv.place(x=220, y=300, width=80)

    rdbw = tkinter.Checkbutton(window4, text="Webcam", variable = rdbtn2, fg = "black", bg = 'purple')
    ...
    tkinter.Label(window4, text="Default values would be assigned to empyt fields", fg = "white", bg = 'purple').place(x=50, y=450, width=380)

    tkinter.Label(window4, bg = 'purple').place(y = 485, width = 800)
    ...
    btn9 = tkinter.Button(window4, text = "CONTINUE",fg = "white", bg = 'purple', command = submit)
    btn9.place(x=650, y=200, width=90)

    btn9 = tkinter.Button(window4, text = "EXIT", fg = "white", bg = 'purple', command = s_exit)
    ...
    btn10 = tkinter.Button(window4, text = "HOME", fg = "white", bg = 'purple', command = home)
...
def show_train():
    ...
    tkinter.Label(window5, text = "^^ WELCOME TO FACE DETECTION AND RECOGNITION SOFTWARE ^^", fg = "white", bg = 'purple').pack(fill="x")
    tkinter.Label(window5, text = '', bg='purple').pack(fill='x')
    ...
    ckbt1 = tkinter.Checkbutton(window5, text="Yes", variable = chkbtn1,fg="black", bg="purple")
    ckbt1.place(x=350, y=350, width=50)

    ckbt2 = tkinter.Checkbutton(window5, text="No", variable = chkbtn2, fg="black", bg="purple")
    ...
    tkinter.Label(window5, text="Default values would be assigned to empyt fields", fg = "white", bg = 'purple').place(x=60, y=450, width=380)
    ...
    btn9 = tkinter.Button(window5, text = "CONTINUE", fg = "white", bg = 'purple', command = submit)
    btn9.place(x=650, y=200, width=90)

    btn9 = tkinter.Button(window5, text = "EXIT", fg = "white", bg = 'purple', command = s_exit)
    btn9.place(x=650, y=300, width=90)
    ...
    btn10 = tkinter.Button(window5, text = "HOME", fg = "white", bg = 'purple', command = home)
    btn10.place(x=650, y=250, width=90)
...
def show_test():
    ...
    tkinter.Label(window6, text = "^^ WELCOME TO FACE DETECTION AND RECOGNITION SOFTWARE ^^",fg = "white", bg = 'purple').pack(fill="x")
    tkinter.Label(window6, text = '', bg='purple').pack(fill='x')
    ...
    tkinter.Label(window6, text="Default values would be assigned to empyt fields", fg = "white", bg = 'purple').place(x=60, y=450, width=380)
    ...
    btn9 = tkinter.Button(window6, text = "CONTINUE", fg = "white", bg = 'purple', command = submit)
    btn9.place(x=650, y=200, width=90)

    btn9 = tkinter.Button(window6, text = "EXIT", fg = "white", bg = 'purple', command = s_exit)
    btn9.place(x=650, y=300, width=90)
    ...
    btn10 = tkinter.Button(window6, text = "HOME", fg = "white", bg = 'purple', command = home)
    btn10.place(x=650, y=250, width=90)
